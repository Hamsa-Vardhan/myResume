        ...
        <React.Fragment>
            ...
            <div className="App container mt-3">
                <header className="row">
                    <h1 className=" col-12 text-center text-white">
                        Hamsa Vardhan
                    </h1>
                ...
                <div className="row parent">
                    <div className="col-sm-12 col-lg-4 left-side ">
                        <img
                            src={ccd}
                            alt="ccd"
                            className="img-thumbnail d-none  d-lg-block d-xl-block"
                        />
                        <div className="col-12 row contact">
                            ...
                            <p className="col-12">
                                <IoIosMailOpen className="mr-2" />{" "}
                                hamsavardhan99@gmail.com
                            </p>
                            <p className="col-12">
                                <FaHome className="mr-2" /> Srikakulam AP code:
                                532127
                            </p>
                        </div>
                        <div className="col-12 row portfolio">
                            ...
                            <a
                                href="https://hamsa-vd.github.io/portfolio/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="col-12"
                                style={{ cursor: "pointer" }}
                            >
                                https://hamsa-vd.github.io/portfolio/
                            </a>
                        </div>
                    ...
                    <div className="right-side col-sm-12 col-lg-8 border-dark">
                        <div className="col-12 row about">
                            <span className="container-fluid row">
                                {" "}
                                <h3 className="col-5">
                                    <FaUser className="mr-2" size={"1.5rem"} />
                                    About Me
                                </h3>{" "}
                            ...
                            <p className="container-fluid">
                                Fervent web developer with great enthusiasm to
                                enrich web. I prefer to keep learning, continue
                                challenging myself, and do interesting things
                                that matter. My abundant energy fuels me in the
                                pursuit of many interests, hobbies, areas of
                                study and artistic endeavors. I’m a fast
                                learner, able to pick up new skills and juggle
                        ...
                        <div className="col-12 row">
                            <span className="container-fluid row">
                                {" "}
                                <h3 className="col-5">
                                    <MdWork className="mr-2" size={"1.5rem"} />
                                    Experience
                                </h3>{" "}
                                <span className="col-7">
                                    <hr
